...
abstract public class AudioService extends Service {
    ...
    public static final String RAW_FILE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/accuspeech/raw/";
    public static final String PAST_RECORDINGS_FILE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/accuspeech/";
    ...
    public static final String DEFAULT_WAV_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/accuspeech/";
}
